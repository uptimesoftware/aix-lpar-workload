...
import com.uptimesoftware.uptime.base.erdc.instance.DefiningErdcClassForParentByErdcIdLoader;
...
public class CustomServiceMonitorVariables extends MonitorWithMonitorVariables {
    ...
    private String getSystemTypeString(Session session) {
            ...
            EntitySubType entitySubType = getEntitySubType(session);
            String erdcBaseClassName = getErdcBaseClassName(session);

            return CustomScriptSytemTypeString.create(entitySubType, erdcBaseClassName);
    }
    ...
    private String getErdcBaseClassName(Session session) {
            DefiningErdcClassForParentByErdcIdLoader loader = new DefiningErdcClassForParentByErdcIdLoader();
            loader.setErdcId(getInstanceId());
